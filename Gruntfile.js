...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      examples: {
        files: {
          'build/tablepricing.min.js': [
            'bower_components/tablepricing/src/tablepricing.js'
          ]
        }
      }
    },
    ...
    copy: {
      ...
      build: {
        files:[{
          expand: true,
          cwd: 'build',
          dest: 'bower_components/tablepricing/build',
          src: '**/*'
        }, {
          expand: true,
          cwd: 'bower_components/tablepricing/src',
          dest: 'build',
          src: '**/*'
        }]  
      }
